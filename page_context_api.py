"""
LoCoMo page-context (LFU hot cache + vector retrieval) evaluation using commercial API models.

Usage:
    python page_context_api.py --model claude-haiku-4-5
    python page_context_api.py --model gpt-4.1-mini
    python page_context_api.py --model deepseek-v4-flash
    python page_context_api.py --model kimi-k2.5
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LoCoMo page-context eval with commercial APIs")
    parser.add_argument(
    ...
    parser.add_argument(
        "--output", default=None,
        help="Output JSON path (default: results_pagecontext_<model>.json)",
    )
...
if __name__ == "__main__":
    ...
    output = args.output or f"results_pagecontext_{args.model}.json"
